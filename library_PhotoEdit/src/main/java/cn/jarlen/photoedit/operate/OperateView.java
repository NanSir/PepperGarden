...
import static cn.jarlen.photoedit.scrawl.DrawAttribute.paint;
...
public class OperateView extends View {
    ...
    public OperateView(Context context, View view) {
        super(context);
        mCanvasLimits = new Rect(0, 0, view.getWidth(), view.getHeight());
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (bgBmp != null) {
            canvas.drawBitmap(bgBmp, 0, 0, new Paint());
        }
        drawImages(canvas);
